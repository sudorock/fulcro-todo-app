...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52919_SHARP_){
return expound.printer.str_width(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__52919_SHARP_,i))));
}),rows));
});
expound.printer.max_row_height = (function expound$printer$max_row_height(row){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52921_SHARP_){
return cljs.core.count(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__52921_SHARP_)));
}),row));
});
...
var G__52924 = ["%-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(column_widths,i)),"s"].join('');
var G__52925 = v;
return (expound.printer.format.cljs$core$IFn$_invoke$arity$2 ? expound.printer.format.cljs$core$IFn$_invoke$arity$2(G__52924,G__52925) : expound.printer.format.call(null,G__52924,G__52925));
}),row);
}),multi_row);
}),multi_rows);
});
...
var columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52954_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__52954_SHARP_)).length),"-"));
}),header);
var header_columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52955_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__52955_SHARP_)).length),"="));
}),header);
...
var iter__4523__auto__ = (function expound$printer$multirow_$_iter__52966(s__52967){
...
var c__4521__auto__ = cljs.core.chunk_first(s__52967__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__52969 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__52968 = (0);
while(true){
if((i__52968 < size__4522__auto__)){
var row_idx = cljs.core._nth(c__4521__auto__,i__52968);
cljs.core.chunk_append(b__52969,(function (){var iter__4523__auto__ = ((function (i__52968,row_idx,c__4521__auto__,size__4522__auto__,b__52969,s__52967__$2,temp__5735__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__52966_$_iter__52974(s__52975){
return (new cljs.core.LazySeq(null,((function (i__52968,row_idx,c__4521__auto__,size__4522__auto__,b__52969,s__52967__$2,temp__5735__auto__,split_row_contents){
return (function (){
var s__52975__$1 = s__52975;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__52975__$1);
if(temp__5735__auto____$1){
var s__52975__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__52975__$2)){
var c__4521__auto____$1 = cljs.core.chunk_first(s__52975__$2);
var size__4522__auto____$1 = cljs.core.count(c__4521__auto____$1);
var b__52977 = cljs.core.chunk_buffer(size__4522__auto____$1);
if((function (){var i__52976 = (0);
while(true){
if((i__52976 < size__4522__auto____$1)){
var col_idx = cljs.core._nth(c__4521__auto____$1,i__52976);
cljs.core.chunk_append(b__52977,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__53313 = (i__52976 + (1));
i__52976 = G__53313;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__52977),expound$printer$multirow_$_iter__52966_$_iter__52974(cljs.core.chunk_rest(s__52975__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__52977),null);
}
} else {
var col_idx = cljs.core.first(s__52975__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__52966_$_iter__52974(cljs.core.rest(s__52975__$2)));
}
} else {
return null;
}
...
});})(i__52968,row_idx,c__4521__auto__,size__4522__auto__,b__52969,s__52967__$2,temp__5735__auto__,split_row_contents))
,null,null));
});})(i__52968,row_idx,c__4521__auto__,size__4522__auto__,b__52969,s__52967__$2,temp__5735__auto__,split_row_contents))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__52969),expound$printer$multirow_$_iter__52966(cljs.core.chunk_rest(s__52967__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__52969),null);
}
} else {
var row_idx = cljs.core.first(s__52967__$2);
return cljs.core.cons((function (){var iter__4523__auto__ = ((function (row_idx,s__52967__$2,temp__5735__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__52966_$_iter__52986(s__52987){
return (new cljs.core.LazySeq(null,(function (){
var s__52987__$1 = s__52987;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__52987__$1);
if(temp__5735__auto____$1){
var s__52987__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__52987__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__52987__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__52989 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__52988 = (0);
while(true){
if((i__52988 < size__4522__auto__)){
var col_idx = cljs.core._nth(c__4521__auto__,i__52988);
cljs.core.chunk_append(b__52989,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__53316 = (i__52988 + (1));
i__52988 = G__53316;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__52989),expound$printer$multirow_$_iter__52966_$_iter__52986(cljs.core.chunk_rest(s__52987__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__52989),null);
}
} else {
var col_idx = cljs.core.first(s__52987__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__52966_$_iter__52986(cljs.core.rest(s__52987__$2)));
}
} else {
return null;
}
...
});})(row_idx,s__52967__$2,temp__5735__auto__,split_row_contents))
;
return iter__4523__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})(),expound$printer$multirow_$_iter__52966(cljs.core.rest(s__52967__$2)));
}
} else {
return null;
}
...
var rows = cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [column_keys], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52991_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(p1__52991_SHARP_,column_keys);
}),map_rows));
...
var form = (function (){var G__53010 = via;
var G__53010__$1 = (((G__53010 == null))?null:cljs.core.last(G__53010));
if((G__53010__$1 == null)){
return null;
} else {
return cljs.spec.alpha.form(G__53010__$1);
}
})();
...
var seq__53043_53423 = cljs.core.seq(problems);
var chunk__53045_53424 = null;
var count__53046_53425 = (0);
var i__53047_53426 = (0);
while(true){
if((i__53047_53426 < count__53046_53425)){
var p_53428 = chunk__53045_53424.cljs$core$IIndexed$_nth$arity$2(null,i__53047_53426);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_53428) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__53430 = seq__53043_53423;
var G__53431 = chunk__53045_53424;
var G__53432 = count__53046_53425;
var G__53433 = (i__53047_53426 + (1));
seq__53043_53423 = G__53430;
chunk__53045_53424 = G__53431;
count__53046_53425 = G__53432;
i__53047_53426 = G__53433;
continue;
} else {
var temp__5735__auto___53434 = cljs.core.seq(seq__53043_53423);
if(temp__5735__auto___53434){
var seq__53043_53435__$1 = temp__5735__auto___53434;
if(cljs.core.chunked_seq_QMARK_(seq__53043_53435__$1)){
var c__4550__auto___53437 = cljs.core.chunk_first(seq__53043_53435__$1);
var G__53438 = cljs.core.chunk_rest(seq__53043_53435__$1);
var G__53439 = c__4550__auto___53437;
var G__53440 = cljs.core.count(c__4550__auto___53437);
var G__53441 = (0);
seq__53043_53423 = G__53438;
chunk__53045_53424 = G__53439;
count__53046_53425 = G__53440;
i__53047_53426 = G__53441;
continue;
} else {
var p_53444 = cljs.core.first(seq__53043_53435__$1);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_53444) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__53445 = cljs.core.next(seq__53043_53435__$1);
var G__53446 = null;
var G__53447 = (0);
var G__53448 = (0);
seq__53043_53423 = G__53445;
chunk__53045_53424 = G__53446;
count__53046_53425 = G__53447;
i__53047_53426 = G__53448;
continue;
}
} else {
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,k,((cljs.core.qualified_keyword_QMARK_(k))?k:(function (){var or__4120__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53041_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),cljs.core.name(p1__53041_SHARP_));
}),specs));
...
expound.printer.summarize_key_clause = (function expound$printer$summarize_key_clause(p__53146){
var vec__53148 = p__53146;
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53148,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53148,(1),null);
var G__53151 = branch;
var G__53151__$1 = (((G__53151 instanceof cljs.core.Keyword))?G__53151.fqn:null);
switch (G__53151__$1) {
case "simple":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__53151__$1)].join('')));

}
});
expound.printer.missing_key = (function expound$printer$missing_key(form){
var vec__53154 = cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","contains-key-pred","expound.spec/contains-key-pred",-989075236),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,(2)));
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53154,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53154,(1),null);
var G__53158 = branch;
var G__53158__$1 = (((G__53158 instanceof cljs.core.Keyword))?G__53158.fqn:null);
switch (G__53158__$1) {
case "simple":
return new cljs.core.Keyword(null,"kw","kw",1158308175).cljs$core$IFn$_invoke$arity$1(match);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__53158__$1)].join('')));
...
var len__4730__auto___53465 = arguments.length;
var i__4731__auto___53466 = (0);
while(true){
if((i__4731__auto___53466 < len__4730__auto___53465)){
args__4736__auto__.push((arguments[i__4731__auto___53466]));

var G__53467 = (i__4731__auto___53466 + (1));
i__4731__auto___53466 = G__53467;
continue;
} else {
}
break;
...
/** @this {Function} */
(expound.printer.format.cljs$lang$applyTo = (function (seq53169){
var G__53170 = cljs.core.first(seq53169);
var seq53169__$1 = cljs.core.next(seq53169);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53170,seq53169__$1);
}));
...
var keys = expound.printer.keywords(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53187_SHARP_){
return expound.printer.missing_key(new cljs.core.Keyword(null,"pred","pred",1927423397).cljs$core$IFn$_invoke$arity$1(p1__53187_SHARP_));
}),problems));
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__53188_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__53188_SHARP_,"key");
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__53192){
...
var _STAR_print_newline_STAR__orig_val__53202_53483 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__53203_53484 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__53204_53485 = true;
var _STAR_print_fn_STAR__temp_val__53205_53486 = (function (x__4662__auto__){
return sb__4661__auto__.append(x__4662__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__53204_53485);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__53205_53486);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__53203_53484);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__53202_53483);
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53208_SHARP_){
return expound.ansi.color.cljs$core$IFn$_invoke$arity$variadic(p1__53208_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"correct-key","correct-key",1087492967)], 0));
...
var vec__53251 = clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));
...
var line = first__53253;
var lines = seq__53252__$1;
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(first_line_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53239_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(rest_lines_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53239_SHARP_)].join('');
}),lines)));
}));
...
while(true){
var vec__53265 = in$;
var seq__53266 = cljs.core.seq(vec__53265);
var first__53267 = cljs.core.first(seq__53266);
var seq__53266__$1 = cljs.core.next(seq__53266);
var k = first__53267;
var rst = seq__53266__$1;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__53268 = show_valid_values_QMARK_;
var G__53269 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__53270 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__53268,G__53269,G__53270) : expound.printer.summary_form.call(null,G__53268,G__53269,G__53270));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__53512 = show_valid_values_QMARK_;
var G__53513 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__53514 = rst__$1;
show_valid_values_QMARK_ = G__53512;
form = G__53513;
in$ = G__53514;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__53274 = show_valid_values_QMARK_;
var G__53275 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__53276 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__53274,G__53275,G__53276) : expound.printer.summary_form.call(null,G__53274,G__53275,G__53276));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__53277 = show_valid_values_QMARK_;
var G__53278 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__53279 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__53277,G__53278,G__53279) : expound.printer.summary_form.call(null,G__53277,G__53278,G__53279));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__53280 = show_valid_values_QMARK_;
var G__53281 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__53282 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__53280,G__53281,G__53282) : expound.printer.summary_form.call(null,G__53280,G__53281,G__53282));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__53283 = show_valid_values_QMARK_;
var G__53284 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__53285 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__53283,G__53284,G__53285) : expound.printer.summary_form.call(null,G__53283,G__53284,G__53285));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53286_SHARP_){
return ((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53286_SHARP_)).length);
...
var map__53287 = problem;
var map__53287__$1 = (((((!((map__53287 == null))))?(((((map__53287.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53287.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__53287):map__53287);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53287__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53287__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__53288 = opts;
...
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__53288__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__53294 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__53295 = false;
(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__53295);
...
}finally {(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__53294);
}})();
var vec__53289 = cljs.core.re_find(regex,s);
var seq__53290 = cljs.core.seq(vec__53289);
var first__53291 = cljs.core.first(seq__53290);
var seq__53290__$1 = cljs.core.next(seq__53290);
var line = first__53291;
var first__53291__$1 = cljs.core.first(seq__53290__$1);
var seq__53290__$2 = cljs.core.next(seq__53290__$1);
var prefix = first__53291__$1;
var _more = seq__53290__$2;
