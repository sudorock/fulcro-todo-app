...
var len__4730__auto___61644 = arguments.length;
var i__4731__auto___61645 = (0);
while(true){
if((i__4731__auto___61645 < len__4730__auto___61644)){
args__4736__auto__.push((arguments[i__4731__auto___61645]));

var G__61646 = (i__4731__auto___61645 + (1));
i__4731__auto___61645 = G__61646;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.go_BANG_.cljs$lang$applyTo = (function (seq61610){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq61610));
}));

shadow.util.console_QMARK_ = (typeof console !== 'undefined');
shadow.util.log = (function shadow$util$log(var_args){
var G__61623 = arguments.length;
switch (G__61623) {
case 1:
...
var len__4730__auto___61659 = arguments.length;
var i__4731__auto___61660 = (0);
while(true){
if((i__4731__auto___61660 < len__4730__auto___61659)){
args_arr__4751__auto__.push((arguments[i__4731__auto___61660]));

var G__61661 = (i__4731__auto___61660 + (1));
i__4731__auto___61660 = G__61661;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq61614){
var G__61615 = cljs.core.first(seq61614);
var seq61614__$1 = cljs.core.next(seq61614);
var G__61616 = cljs.core.first(seq61614__$1);
var seq61614__$2 = cljs.core.next(seq61614__$1);
var G__61617 = cljs.core.first(seq61614__$2);
var seq61614__$3 = cljs.core.next(seq61614__$2);
var G__61618 = cljs.core.first(seq61614__$3);
var seq61614__$4 = cljs.core.next(seq61614__$3);
var G__61619 = cljs.core.first(seq61614__$4);
var seq61614__$5 = cljs.core.next(seq61614__$4);
var G__61620 = cljs.core.first(seq61614__$5);
var seq61614__$6 = cljs.core.next(seq61614__$5);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61615,G__61616,G__61617,G__61618,G__61619,G__61620,seq61614__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__61635){
var vec__61636 = p__61635;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61636,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61636,(1),null);
