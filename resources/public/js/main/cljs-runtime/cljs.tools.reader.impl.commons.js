...
var G__46062 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__46062;
continue;
} else {
return ch;
...
var vec__46039 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46039,(0),null);
return (match === s);
});
...
var len__4730__auto___46074 = arguments.length;
var i__4731__auto___46076 = (0);
while(true){
if((i__4731__auto___46076 < len__4730__auto___46074)){
args__4736__auto__.push((arguments[i__4731__auto___46076]));

var G__46078 = (i__4731__auto___46076 + (1));
i__4731__auto___46076 = G__46078;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq46051){
var G__46052 = cljs.core.first(seq46051);
var seq46051__$1 = cljs.core.next(seq46051);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46052,seq46051__$1);
}));

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__46083__delegate = function (rdr,_){
...
var G__46083 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__46085__i = 0, G__46085__a = new Array(arguments.length -  1);
while (G__46085__i < G__46085__a.length) {G__46085__a[G__46085__i] = arguments[G__46085__i + 1]; ++G__46085__i;}
  _ = new cljs.core.IndexedSeq(G__46085__a,0,null);
} 
return G__46083__delegate.call(this,rdr,_);};
G__46083.cljs$lang$maxFixedArity = 1;
G__46083.cljs$lang$applyTo = (function (arglist__46086){
var rdr = cljs.core.first(arglist__46086);
var _ = cljs.core.rest(arglist__46086);
return G__46083__delegate(rdr,_);
});
