...
var vec__45432 = temp__5733__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45432,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45432,(1),null);
...
var len__4730__auto___45518 = arguments.length;
var i__4731__auto___45519 = (0);
while(true){
if((i__4731__auto___45519 < len__4730__auto___45518)){
args__4736__auto__.push((arguments[i__4731__auto___45519]));

var G__45520 = (i__4731__auto___45519 + (1));
i__4731__auto___45519 = G__45520;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__45442){
...
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45443__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45443__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45443__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__45445 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45445,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45445,(1),null);
...
var vec__45461 = size_seq__$1;
var seq__45462 = cljs.core.seq(vec__45461);
var first__45463 = cljs.core.first(seq__45462);
var seq__45462__$1 = cljs.core.next(seq__45462);
var size = first__45463;
var rest_size_seq = seq__45462__$1;
var vec__45464 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45464,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45464,(1),null);
...
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__45467_45524) : reporter_fn.call(null,G__45467_45524));

var G__45531 = so_far__$1;
var G__45532 = rest_size_seq;
var G__45533 = r2;
so_far = G__45531;
size_seq__$1 = G__45532;
rstate = G__45533;
continue;
} else {
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq45439){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45440,G__45441,seq45439__$2);
}));
...
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45473__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__45551 = tail;
var G__45552 = current_smallest;
var G__45553 = (total_nodes_visited + (1));
var G__45554 = depth;
nodes = G__45551;
current_smallest = G__45552;
total_nodes_visited = G__45553;
depth = G__45554;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__45486_45555 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__45486_45555) : reporter_fn.call(null,G__45486_45555));

var temp__5733__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5733__auto__){
var children = temp__5733__auto__;
var G__45559 = children;
var G__45560 = new_smallest;
var G__45561 = (total_nodes_visited + (1));
var G__45562 = (depth + (1));
nodes = G__45559;
current_smallest = G__45560;
total_nodes_visited = G__45561;
depth = G__45562;
continue;
} else {
var G__45563 = tail;
var G__45564 = new_smallest;
var G__45565 = (total_nodes_visited + (1));
var G__45566 = depth;
nodes = G__45563;
current_smallest = G__45564;
total_nodes_visited = G__45565;
depth = G__45566;
continue;
}
}
...
var G__45500_45570 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__45500_45570) : reporter_fn.call(null,G__45500_45570));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__45487_SHARP_){
var G__45501 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__45487_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__45501) : reporter_fn.call(null,G__45501));
}));
var G__45503_45571 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__45503_45571) : reporter_fn.call(null,G__45503_45571));
