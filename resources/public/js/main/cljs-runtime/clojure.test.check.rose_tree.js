...
(clojure.test.check.rose_tree.RoseTree.cljs$lang$ctorPrWriter = (function (this__4363__auto__,writer__4364__auto__,opt__4365__auto__){
return cljs.core._write(writer__4364__auto__,"clojure.test.check.rose-tree/RoseTree");
}));
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__44371 = (n - (1));
var G__44372 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__44371,G__44372) : clojure.test.check.rose_tree.exclude_nth.call(null,G__44371,G__44372));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__44381 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__44381) : f.call(null,G__44381));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44380_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__44380_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__44380_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44385_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__44385_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__44385_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__44386_SHARP_){
var G__44388 = clojure.test.check.rose_tree.root(p1__44386_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__44388) : pred.call(null,G__44388));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__4523__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__44391(s__44392){
return (new cljs.core.LazySeq(null,(function (){
var s__44392__$1 = s__44392;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__44392__$1);
if(temp__5735__auto__){
var xs__6292__auto__ = temp__5735__auto__;
var vec__44398 = cljs.core.first(xs__6292__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44398,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44398,(1),null);
var iterys__4519__auto__ = ((function (s__44392__$1,vec__44398,rose,index,xs__6292__auto__,temp__5735__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__44391_$_iter__44393(s__44394){
return (new cljs.core.LazySeq(null,((function (s__44392__$1,vec__44398,rose,index,xs__6292__auto__,temp__5735__auto__){
return (function (){
var s__44394__$1 = s__44394;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__44394__$1);
if(temp__5735__auto____$1){
var s__44394__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__44394__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__44394__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__44396 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__44395 = (0);
while(true){
if((i__44395 < size__4522__auto__)){
var child = cljs.core._nth(c__4521__auto__,i__44395);
cljs.core.chunk_append(b__44396,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__44441 = (i__44395 + (1));
i__44395 = G__44441;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__44396),clojure$test$check$rose_tree$permutations_$_iter__44391_$_iter__44393(cljs.core.chunk_rest(s__44394__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__44396),null);
}
} else {
var child = cljs.core.first(s__44394__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__44391_$_iter__44393(cljs.core.rest(s__44394__$2)));
}
} else {
return null;
}
...
});})(s__44392__$1,vec__44398,rose,index,xs__6292__auto__,temp__5735__auto__))
,null,null));
});})(s__44392__$1,vec__44398,rose,index,xs__6292__auto__,temp__5735__auto__))
;
var fs__4520__auto__ = cljs.core.seq(iterys__4519__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__4520__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4520__auto__,clojure$test$check$rose_tree$permutations_$_iter__44391(cljs.core.rest(s__44392__$1)));
} else {
var G__44444 = cljs.core.rest(s__44392__$1);
s__44392__$1 = G__44444;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44405_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__44405_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__44405_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44410_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__44410_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__44410_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__44411 = f;
var G__44412 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__44411,G__44412) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__44411,G__44412));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__44413 = f;
var G__44414 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__44413,G__44414) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__44413,G__44414));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
