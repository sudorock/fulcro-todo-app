...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42300){
var G__42301 = cljs.core.first(seq42300);
var seq42300__$1 = cljs.core.next(seq42300);
var G__42302 = cljs.core.first(seq42300__$1);
var seq42300__$2 = cljs.core.next(seq42300__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42301,G__42302,seq42300__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42329_SHARP_){
return (!((cljs.core.meta(p1__42329_SHARP_) == null)));
})))){
...
var map__42346 = opts;
var map__42346__$1 = (((((!((map__42346 == null))))?(((((map__42346.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42346.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42346):map__42346);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42346__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42353){var _e__41797__auto__ = e42353;
return false;
}})();
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
...
}catch (e42355){var _e__41797__auto__ = e42355;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42357 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42358 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42358);

try{var map__42360 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42360__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42357);
}});
...
var temp__5733__auto___42404 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___42404)){
var managed_print_level_42405 = temp__5733__auto___42404;
var _STAR_print_level_STAR__orig_val__42373_42406 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42374_42407 = managed_print_level_42405;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42374_42407);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42368_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42368_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42373_42406);
}} else {
job_fn();
}
