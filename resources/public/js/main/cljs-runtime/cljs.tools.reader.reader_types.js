...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_45852 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_45852(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_45857 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_45857(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45863 = (function (reader,ch){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45863(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45870 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45870(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45874 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45874(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45886 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45886(reader);
}
});
...
var G__45932 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__45933 = s.append(c);
c = G__45932;
s = G__45933;
continue;
}
