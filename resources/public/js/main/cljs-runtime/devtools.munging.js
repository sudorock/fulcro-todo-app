...
var o42028 = temp__5733__auto__;
var temp__5733__auto____$1 = (o42028["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o42029 = temp__5733__auto____$1;
return (o42029["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__41778__auto__ = f;
return (o__41778__auto__["toString"]).call(o__41778__auto__);
} else {
return "";
}
}catch (e42038){var _ = e42038;
return "";
}});
...
try{var o__41778__auto___42237 = t;
(o__41778__auto___42237["cljs$lang$ctorPrWriter"]).call(o__41778__auto___42237,t,writer);
}catch (e42044){var __42238 = e42044;
}
...
var char_code = (function (){var o__41778__auto__ = (new String(char$));
return (o__41778__auto__["charCodeAt"]).call(o__41778__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__41778__auto__ = String;
return (o__41778__auto__["fromCharCode"]).call(o__41778__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42056 = num_code;
switch (G__42056) {
case (1):
return (185);
...
var o__41778__auto__ = String;
return (o__41778__auto__["fromCharCode"]).call(o__41778__auto__,superscript_code);
});
/**
...
}catch (e42064){var _e__41797__auto__ = e42064;
return false;
}})())){
...
var vec__42069 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42069,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o42081 = temp__5733__auto__;
var temp__5733__auto____$1 = (o42081["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o42082 = temp__5733__auto____$1;
return (o42082["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42085){
var vec__42086 = p__42085;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42086,(0),null);
...
var G__42268 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__42269 = cljs.core.butlast(remaining_tokens);
name_tokens = G__42268;
remaining_tokens = G__42269;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42083){
var G__42084 = cljs.core.first(seq42083);
var seq42083__$1 = cljs.core.next(seq42083);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42084,seq42083__$1);
}));
...
var vec__42091 = cljs.core.split_with((function (p1__42090_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__42090_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42091,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42091,(1),null);
...
var vec__42097 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42097,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42097,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__42277 = cljs.core.rest(remaining_tokens);
var G__42278 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__42277;
name_tokens = G__42278;
continue;
} else {
...
var vec__42102 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42102,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42102,(1),null);
var vec__42105 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42105,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42105,(1),null);
var vec__42108 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42108,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42108,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42108,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42108,(3),null);
...
var vec__42114 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42114,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42114,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42114,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42114,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42114,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42114,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__42117 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42117,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42117,(1),null);
var vec__42120 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42120,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42120,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__42124 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__42124) : devtools.munging.parse_fn_info_deep.call(null,G__42124));
})()));
}
} else {
return fn_info;
...
var G__42298 = (arity + (1));
var G__42299 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42127){
var vec__42128 = p__42127;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42128,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42128,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42137_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__42137_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42138_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__42138_SHARP_);
}),sorted_infos);
...
var args__4736__auto__ = [];
var len__4730__auto___42308 = arguments.length;
var i__4731__auto___42309 = (0);
while(true){
if((i__4731__auto___42309 < len__4730__auto___42308)){
args__4736__auto__.push((arguments[i__4731__auto___42309]));

var G__42312 = (i__4731__auto___42309 + (1));
i__4731__auto___42309 = G__42312;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42141){
var vec__42142 = p__42141;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42142,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq42139){
var G__42140 = cljs.core.first(seq42139);
var seq42139__$1 = cljs.core.next(seq42139);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42140,seq42139__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42154__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42154__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42154__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42154__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42155 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42155,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42155,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42155,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42155,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42155,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42155,(5),null);
...
var o__41778__auto__ = f;
return (o__41778__auto__["getBasis"]).call(o__41778__auto__);
});
/**
...
}catch (e42174){var _e__41797__auto__ = e42174;
...
var G__42339 = (obj[cljs.core.first(path)]);
var G__42340 = cljs.core.rest(path);
obj = G__42339;
path = G__42340;
continue;
} else {
...
var _STAR_ = (function (accum,p__42180){
var vec__42181 = p__42180;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42181,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42181,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42190){
var vec__42191 = p__42190;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42191,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42191,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42191,(2),null);
...
var post_process = (function (p__42200){
var vec__42201 = p__42200;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42201,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42201,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42197_SHARP_){
return (obj[cljs.core.first(p1__42197_SHARP_)]);
}),sorted_matches);
