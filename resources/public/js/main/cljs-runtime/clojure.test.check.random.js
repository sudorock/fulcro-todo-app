...
var clojure$test$check$random$IRandom$rand_long$dyn_44383 = (function (rng){
var x__4422__auto__ = (((rng == null))?null:rng);
var m__4423__auto__ = (clojure.test.check.random.rand_long[goog.typeOf(x__4422__auto__)]);
if((!((m__4423__auto__ == null)))){
return (m__4423__auto__.cljs$core$IFn$_invoke$arity$1 ? m__4423__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__4423__auto__.call(null,rng));
} else {
var m__4420__auto__ = (clojure.test.check.random.rand_long["_"]);
if((!((m__4420__auto__ == null)))){
return (m__4420__auto__.cljs$core$IFn$_invoke$arity$1 ? m__4420__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__4420__auto__.call(null,rng));
} else {
...
return clojure$test$check$random$IRandom$rand_long$dyn_44383(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_44390 = (function (rng){
var x__4422__auto__ = (((rng == null))?null:rng);
var m__4423__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__4422__auto__)]);
if((!((m__4423__auto__ == null)))){
return (m__4423__auto__.cljs$core$IFn$_invoke$arity$1 ? m__4423__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__4423__auto__.call(null,rng));
} else {
var m__4420__auto__ = (clojure.test.check.random.rand_double["_"]);
if((!((m__4420__auto__ == null)))){
return (m__4420__auto__.cljs$core$IFn$_invoke$arity$1 ? m__4420__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__4420__auto__.call(null,rng));
} else {
...
return clojure$test$check$random$IRandom$rand_double$dyn_44390(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_44397 = (function (rng){
var x__4422__auto__ = (((rng == null))?null:rng);
var m__4423__auto__ = (clojure.test.check.random.split[goog.typeOf(x__4422__auto__)]);
if((!((m__4423__auto__ == null)))){
return (m__4423__auto__.cljs$core$IFn$_invoke$arity$1 ? m__4423__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__4423__auto__.call(null,rng));
} else {
var m__4420__auto__ = (clojure.test.check.random.split["_"]);
if((!((m__4420__auto__ == null)))){
return (m__4420__auto__.cljs$core$IFn$_invoke$arity$1 ? m__4420__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__4420__auto__.call(null,rng));
} else {
...
return clojure$test$check$random$IRandom$split$dyn_44397(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_44402 = (function (rng,n){
var x__4422__auto__ = (((rng == null))?null:rng);
var m__4423__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__4422__auto__)]);
if((!((m__4423__auto__ == null)))){
return (m__4423__auto__.cljs$core$IFn$_invoke$arity$2 ? m__4423__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__4423__auto__.call(null,rng,n));
} else {
var m__4420__auto__ = (clojure.test.check.random.split_n["_"]);
if((!((m__4420__auto__ == null)))){
return (m__4420__auto__.cljs$core$IFn$_invoke$arity$2 ? m__4420__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__4420__auto__.call(null,rng,n));
} else {
...
return clojure$test$check$random$IRandom$split_n$dyn_44402(rng,n);
}
});
...
var G__44359 = z;
if(((24) > (function (){var G__44360 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__44360) : clojure.test.check.random.longs.bit_count.call(null,G__44360));
})())){
return clojure.test.check.random.longs.bit_xor(G__44359,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__44359;
}
});
...
var G__44415 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__44416 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__44415;
ret = G__44416;
continue;
}
...
(clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__4363__auto__,writer__4364__auto__,opt__4365__auto__){
return cljs.core._write(writer__4364__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
}));
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__4120__auto__ = clojure.test.check.random.longs.__GT_long(seed);
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__44369){
var map__44370 = p__44369;
var map__44370__$1 = (((((!((map__44370 == null))))?(((((map__44370.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44370.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__44370):map__44370);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44370__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__44374 = clojure.test.check.random.split(state);
