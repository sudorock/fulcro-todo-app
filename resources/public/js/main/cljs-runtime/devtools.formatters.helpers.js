...
var G__42296 = devtools.prefs.pref(v);
v = G__42296;
continue;
} else {
return v;
...
}catch (e42248){var _e__41797__auto__ = e42248;
return false;
}})();
...
}catch (e42255){var _e__41797__auto__ = e42255;
return false;
}})();
...
}catch (e42259){var _e__41797__auto__ = e42259;
return false;
}}
}
});
...
var vec__42274 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42274,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42274,(1),null);
...
return cljs.core.some((function (p1__42279_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42279_SHARP_);
}),template);
});
